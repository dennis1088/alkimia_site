...
<div id="blog-index">
	...
	<div class="entry <?php   echo $firstClass; ?>">
		<div class="title">
		<?php 
		if ($cobj->getAttribute('blog_thumbnail')) {
 			$image = $imgHelper->getThumbnail($cobj->getAttribute('blog_thumbnail'), 100, 100)->src;?>
		<img src="<?php  echo $image; ?>" style="float:left; margin:10px;"/><?php  }?>
			<h3>
